        ...
        <li className="nav-item">
          ...
          <>
           <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><NavLink to={`/dashboard/${auth.auth?.user?.role === 1 ? 'admin' : 'user'}`} className="dropdown-item">Dashboard</NavLink></li>
              <li><NavLink onClick={handleLogout} to='/login' className="nav-link dropdown-item">Logout</NavLink></li>
